...
public class ReservasView extends JFrame {
	...
	private void actualizarValorReserva() {
		...
		if (fechaEntrada != null && fechaSalida != null) {
			...
			int dias = (int) (diff / (24 * 60 * 60 * 1000)); // Diferencia en días

			if (dias >= 0) {
				int valor = dias * 20000; // Calcular el valor
				txtValor.setText(Integer.toString(valor)); // Actualizar el campo de valor
			} else {
				// Si la fecha de salida es anterior a la fecha de entrada, mostrar un mensaje
				// de error
				txtValor.setText("");
			}
		}
	...
	// Dentro de la clase ReservasView
	private Reserva guardar() {
		...
		return null; // Devolver null si no se pueden capturar los datos correctamente
	}
