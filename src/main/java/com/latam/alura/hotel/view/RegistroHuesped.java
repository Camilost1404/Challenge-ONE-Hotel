...
public class RegistroHuesped extends JFrame {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (!txtNombre.getText().isEmpty() && !txtApellido.getText().isEmpty()
						&& !txtTelefono.getText().isEmpty() && txtFechaN.getDate() != null) {
					guardar(reserva);
	...
	public void guardar(Reserva reserva) {
		...
		} catch (Exception e) { // Manejar excepciones, por ejemplo, mostrar un mensaje de error
			e.printStackTrace(); // Si ocurre un error, puedes hacer un rollback de la transacción
			entityManager.getTransaction().rollback();
		} finally {
			entityManager.close();
		}
